...
{elseif $mode == "add"}
      ...
      {elseif $def.type == "textarea"}
        {include file='textarea_toolbar.tpl' textarea=$header}<span class="info_label">Characters Remaining</span><input readonly class='text_counter' type="text" name="{$header}_Len" size="3" maxlength="3" value="{if $def.maxsize}{$def.maxsize}{else}{math equation='x * y' x=$def.rowsize y=$def.colsize}{/if}" class="text_counter">
