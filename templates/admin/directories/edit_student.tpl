...
<h3>Photograph</h3>
<a href="?section=directories&function=display_photo&user_id={$object->username}&fullsize=true" >
<img width="200" border="0"  src="?section=directories&function=display_photo&user_id={$object->username}" /></a>
