...
{if $placed}
{include file="admin/directories/company_applicants_subsection.tpl" applications=$placed subsection_title="Already Selected"}
{/if}

{if $available}
{include file="admin/directories/company_applicants_subsection.tpl" applications=$available subsection_title="Still Available"}
{/if}

{if $unavailable}
{include file="admin/directories/company_applicants_subsection.tpl" applications=$unavailable subsection_title="No Longer Available"}
{/if}
  <span style="float: right"><input class="button" type="submit" class="submit" value="update" /></span>
</form>
