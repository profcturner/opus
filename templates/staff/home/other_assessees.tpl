...
<div id="table_list">
  <table cellpadding="0" cellspacing="0" border="0">
    ...
    <tr class="{cycle name="cycle1" values="dark_row,light_row"}">
      ...
      <td class="action"><a href="?section=home&function=edit_assessment&id={$other_assessments[other_assessments]->regime_id}&assessed_id={$other_assessments[other_assessments]->assessed_id}">edit</a></td>
    </tr>
    {sectionelse}
    {#none_found#}
    {/section}
