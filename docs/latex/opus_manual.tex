...
After installation, it is usually necessary to copy the file config.php.dist to
config.php and customize its values.\footnote{Debian installation will take care of this aspect.}
